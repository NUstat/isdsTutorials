...
format.inline_question_answer <- function(x, ..., spacing = "") {
...
#' @export
#' @rdname format_quiz
format.inline_question <- function(x, ..., spacing = "") {
  ...
  paste0(
    spacing, "Question: \"",
    paste0(x$question, x$answers, x$question, "\"\n"),
...
#' @export
#' @rdname format_quiz
print.inline_question <- cat_format
#' @export
#' @rdname format_quiz
print.inline_question_answer <- cat_format
#' @export
#' @rdname format_quiz
print.inline_quiz <- cat_format
