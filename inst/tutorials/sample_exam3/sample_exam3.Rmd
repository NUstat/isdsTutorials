...
quiz(
  ...
  #Q1
  question_text(
  paste0("Q1) Consider a population that has a unimodal right-skewed distribution. Which of the following pictures would best represent a sampling distribution where repeated samples were taken of size $n = 30$? <br>
  
  a) ", htmltools::img(src="images/sampling_01a.png", height = 200, width = 400) ,"<br>
  b) ", htmltools::img(src="images/sampling_01c.png", height =300, width = 300) ,"
  c) ", htmltools::img(src="images/sampling_01b.png", height = 300, width = 300)),
  answer(c("wrong"), 
         correct = TRUE),
  allow_retry = TRUE,
  incorrect = "submitted"),
  ...
  b) There is a 4% chance our interval does not contain $\\mu$. <br>
  ...
  question_text(
  "Q10) You are conducting a hypothesis test and change your significance level from $\\alpha = 0.10$ to $\\alpha = 0.5$. How doe sthis impact your Type II error rate? <br> <br>
