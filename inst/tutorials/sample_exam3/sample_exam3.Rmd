...
quiz(
  ...
  incorrect = "submitted"),
  question_dropdown(
  "Q10) You are conducting a hypothesis test and change your significance level from $\\alpha = 0.10$ to $\\alpha = 0.05$. How does this impact your Type II error rate?",
