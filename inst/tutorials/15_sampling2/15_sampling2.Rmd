...
```{r, context = "server"}
rubric_list <- data.frame(question = c("Name","Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8"),
...
Complete this tutorial while reading Sections 9.2 - 9.4 of the [textbook](https://nustat.github.io/intro-stat-data-sci/09-sampling-distributions.html).
