...
quiz(caption = NULL,
  ...
  question("Q7) Which of the following lines of code will store the value 30 in the object x? Select all that apply.",
           ...
           random_answer_order = TRUE), 
    # Q8
    question_matching("Q8) Seeing red text in your console is not always bad. Order the three different types of feedback R gives (on right) to match how they should be interpreted.",
        ...
        allow_retry = TRUE ),
  # Q9
    question_matching("Q9) Match the order of the following packages with their primary purpose",
