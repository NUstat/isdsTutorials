...
```{r how-to-code-6}
quiz(caption = "Seeing red text in your console is not always bad. Drag and drop the three different types of feedback R givew with how they should be interpreted.",
     question_dropdown(
        "everything is working fine, but watch out/pay attention (yellow traffic light)",
        answer("Error"),
        answer("Warning", correct = TRUE),
        answer("Message"),
        allow_retry = TRUE ),
     question_dropdown(
        "something is wrong! (red traffic light)",
        answer("Error", correct = TRUE),
        answer("Warning"),
        answer("Message"),
        allow_retry = TRUE ),
     question_dropdown(
        "everything is working fine (green traffic light)",
        answer("Error"),
        answer("Warning"),
