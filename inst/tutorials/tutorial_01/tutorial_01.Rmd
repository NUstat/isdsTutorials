...
quiz(caption = NULL,
    # Ex2Q1
  question("Which of the following are names of variables in the mpg data frame?",
           answer("audi"),
           ...
           allow_retry = TRUE), 
  # Ex2Q2
  question("What's the city miles per gallon for the first observation in the mpg dataframe?",
           answer("29"),
...
quiz(caption = NULL,
  ...
  question("Which of the following lines of code will store the value 30 in the object x? Select all that apply.",
    ...
    question_matching("Seeing red text in your console is not always bad. Order the three different types of feedback R gives (on right) to match how they should be interpreted.",
        ...
        allow_retry = TRUE ),
  # Q9
    question_matching("Match the order of the following packages with their primary purpose",
        choices = c("moderndive", "dplyr", "ggplot2"),
        answer(c("accompanies this book","data wrangling",  "data visualization"), correct = TRUE), 
        allow_retry = TRUE )
)
```
