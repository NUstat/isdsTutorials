...
quiz(
 ...
 question_numeric("Q6) In the table above, how many variables are categorical?",
 ...
 question_text(
  "Q9) Name one statistic that is invariant to outliers.",
...
-   **No Name = 0 grade**
-   Make sure all questions and exercises are **SUBMITTED**
