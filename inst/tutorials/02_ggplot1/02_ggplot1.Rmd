...
quiz(
  ...
  # Q3
  question_matching(paste("Q3) Match the variables with the aesthetics they are mapped onto in Figure 2.1", htmltools::img(src="images/Figure_02_1.png", height = 400, width = 700) ),
