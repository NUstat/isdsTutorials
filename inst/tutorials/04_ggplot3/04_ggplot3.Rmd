...
quiz(caption = NULL,
  # Q1
    question("Q1) Which of the following summary statistics are included in the five-number summary and are used to construct a boxplot when there are no “outliers” in the data?",
           ...
           random_answer_order = TRUE), 
  # Q2
    question_matching("Q2) Match the features of a boxplot with the information they display about the data by reordering the information in the right column.",
        choices = c("whiskers", "length", "dots", "box"),
        answer(c("lines extending from the box to points less than the 25th percentile or greater than the 75th percentile",
