...
```{r, context = "server"}
rubric_list <- data.frame(question = c("Name","Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9", "Q10"),
...
Complete this tutorial while reading Chapter 10 of the [textbook](https://nustat.github.io/intro-stat-data-sci/10-confidence-intervals.html).
