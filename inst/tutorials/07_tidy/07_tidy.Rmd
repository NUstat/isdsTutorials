...
```{r tidy-data-1}
question_radio(
  "Which data set is in 'long format'?",
  answer("drinks_smaller"),
  answer("drinks_smaller_tidy", correct = TRUE),
  allow_retry = TRUE
)
# question_wordbank(,
...
```{r tidy-data-2}
quiz(caption = "Complete the following three statements that define tidy data.",
  question_radio("Each variable forms a _____.",
                 answer("column", correct = TRUE),
                 answer("row"),
                 answer("table"),
                 answer("value"),
                 allow_retry = TRUE,
                 random_answer_order = TRUE),
  question_radio("Each observation forms a _____.",
                 answer("column", correct = TRUE),
                 answer("row"),
                 answer("table"),
                 answer("value"),
